...
namespace Aitoe.Vigilant.Controller.WpfController.Infra
{
    public static class GridViewColumns
    {
        ...
        /// <summary>
        /// Adds the specified number of Columns to ListView in GridViewMode. 
        /// Default Width is Auto
        /// </summary>
        public static readonly DependencyProperty ColumnCountProperty =
            DependencyProperty.RegisterAttached("ColumnsCount", typeof(int), typeof(GridViewColumns), new PropertyMetadata(-1, ColumnCountChanged));

        public static void ColumnCountChanged(DependencyObject obj, DependencyPropertyChangedEventArgs e)
        {
            // Why should this be GridView rather than 
            //if (!(obj is ListView) || (int)e.NewValue < 0)
            //    return;

            // QQQQQ1. Why should this be GridView rather than ListView??
            if (!(obj is GridView) || (int)e.NewValue < 0)
                return;

            var gridView = (GridView)obj;
            ...
            for (int i = 0; i < (int)e.NewValue; i++)
            {
                ...
                //gvc.DisplayMemberBinding = descriptionBinding;
                //gvc.Header = "HareKrishna";
        ...
        private static GridViewColumn CreateColumn(GridView gridView, object columnSource)
        {
            ...
            if (!string.IsNullOrEmpty(displayMemberMember))
            {
                ...
                //http://stackoverflow.com/a/248638/1977871
                //http://www.codeproject.com/Questions/516614/createplusdatatemplatepluscodeplusbehind

                //http://stackoverflow.com/a/5592399/1977871
                //http://stackoverflow.com/a/17106767/1977871
                //http://www.nullskull.com/faq/1838/use-a-datatemplate-to-associate-a-viewmodel-to-a-view.aspx
                //http://www.tutorialspoint.com/mvvm/mvvm_wpf_data_templates.htm

                //http://stackoverflow.com/a/14054303/1977871
                //http://www.codeproject.com/Articles/444371/Creating-WPF-Data-Templates-in-Code-The-Right-Way

                //DataTemplate template = new DataTemplate();
                //FrameworkElementFactory factory = new FrameworkElementFactory(typeof(SimpleUserControl));
                ////factory.SetValue(SimpleUserControl.CellValueProperty, "Rama");
                //Binding binding = new Binding(propertyName);
                //binding.Path = new PropertyPath("ColumnHeaderText");
                ////factory.SetBinding(SimpleUserControl.CellIdProperty, new Binding(string.Format("[{0}]", "ColumnHeaderText")));
                //factory.SetBinding(SimpleUserControl.CellValueProperty, binding);
